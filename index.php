...
?> 
    ...
    <?php
        foreach($rsc6 as $p6){
            $img6=explode(",",$p6->file_list);
    ?>
        <!-- Single Slide -->
        <div class="welcome-single-slide">
            <!-- Post Thumb -->
            <img src="<?php echo $img6[0];?>" alt="">
            <!-- Overlay Text -->
            <div class="project_title">
                <div class="post-date-commnents d-flex">
                    <a href="#"><?php echo date("Y.m.d",strtotime($p6->reg_date));?></a>
                    <a href="#"><?php echo $p6->reply_cnt;?> Comment</a>
                </div>
                <a href="#">
                    <h6><?php echo $p6->subject;?></h5>
                </a>
            </div>
        </div>
    <?php }?>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-4">
                    <div class="blog-sidebar mt-5 mt-lg-0">
                        ...
                        <div class="single-widget-area about-me-widget text-center">
                            ...
                            <h4 class="font-shadow-into-light"><?php echo $_SESSION['loginValue']['SUNAME'];?></h4>
